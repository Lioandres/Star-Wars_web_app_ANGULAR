// To parse this data:
//
//   import { Convert, ShipList } from "./file";
//
//   const shipList = Convert.toShipList(json);
//
...
export class Convert {
    public static toShipList(json: string): ShipList {
        return cast(JSON.parse(json), r("ShipList"));
    }

    public static shipListToJson(value: ShipList): string {
        return JSON.stringify(uncast(value, r("ShipList")), null, 2);
    }
}
